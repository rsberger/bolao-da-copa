-- ============================================================
-- Scoring with updated stage multipliers + penalty winner rule
-- Stages: Grupos(×1), Trinta e dois(×2), Oitavas(×3),
--         Quartas(×4), Semi(×5), Terceiro(×6), Final(×6)
-- Base: exact=5, diff=3, winner=2, miss=0
-- Penalty rule: if user predicted a winning team, the match drew
-- in regular time, and that same team won on penalties, it counts
